...
<title>DX博客后台</title>
<meta name="description" content="DX博客后台">
		...
		<div class="admin-content-body">
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">欢迎您来到博客后台 </strong>
				</div>
			</div>
			...
			<ul
				...
				<li><a href="#" class="am-text-danger"><span
						class="am-icon-btn am-icon-recycle"></span><br />昨日访问<br /><%=com.dx.ssh.listener.SessionListener.getYestodayTotal() %></a></li>
				<li><a href="#" class="am-text-secondary"><span
						class="am-icon-btn am-icon-user-md"></span><br />在线用户<br /><%=com.dx.ssh.listener.SessionListener.getOnlineUserItems().size() %></a></li>
			</ul>
